...
EuroLib = ['Albania', 'Austria', 'Belgium', 'Bosnia & Herzegovina', 'Bulgaria', 'Croatia', 'Czech Republic', 'Denmark',
           'England', 'Estonia', 'Finland', 'France', 'Germany', 'Greece', 'Hungary', 'Iceland', 'Ireland', 'Italy',
           'Latvia', 'Lithuania', 'Luxembourg', 'Malta', 'Montenegro', 'Netherlands', 'North Macedonia',
           'Northern Ireland', 'Norway', 'Poland', 'Portugal', 'Romania', 'Russia', 'Scotland', 'Serbia', 'Slovakia',
           'Slovenia', 'Spain', 'Sweden', 'Switzerland', 'Turkey', 'Ukraine', 'Wales']

AfroLib = ['Algeria', 'Angola', 'Benin', 'Burkina Faso', 'Burundi', 'Cameroon', 'Cape Verde', 'Comoros', 'Congo Rep.',
           'DRC', 'Egypt', 'Equatorial Guinea', 'Ethiopia', 'Gabon', 'Gambia', 'Ghana', 'Guinea', 'Guinea-Bissau',
           'Ivory Coast', 'Kenya', 'Madagascar', 'Malawi', 'Mali', 'Mauritania', 'Morocco', 'Namibia', 'Niger',
           'Nigeria', 'Rwanda', 'Senegal', 'Seychelles', 'Sierra Leone', 'Somalia', 'South Africa', 'South Sudan',
           'Sudan', 'Tanzania', 'Togo', 'Tunisia', 'Uganda', 'Zambia', 'Zimbabwe']

SALib = ['Argentina', 'Bolivia', 'Brazil', 'Chile', 'Colombia', 'Ecuador', 'Guyana', 'Paraguay', 'Peru', 'Suriname',
         'Uruguay', 'Venezuela']

NALib = ['Bahamas', 'Barbados', 'Belize', 'Bermuda', 'Canada', 'Costa Rica', 'Cuba', 'Curaçao', 'Dominica',
         'Dominican Republic', 'El Salvador', 'French Guiana', 'Grenada', 'Guadeloupe', 'Guatemala', 'Guyana', 'Haiti',
         'Haiti', 'Honduras', 'Jamaica', 'Martinique', 'Mexico', 'Nicaragua', 'Panama', 'Saint Lucia',
         'Snt Vincent & Gren.', 'Suriname', 'Trinidad and Tobago', 'USA']

AsiaLib = ['Australia', 'Bahrain', 'Brunei', 'Cambodia', 'China', 'India', 'Indonesia', 'Iran', 'Iraq', 'Japan',
           'Jordan', 'Kuwait', 'Kyrgyzstan', 'Laos', 'Lebanon', 'Malaysia', 'Maldives', 'Mongolia', 'Myanmar (Burma)',
           'Nepal', 'North Korea', 'Oman', 'Pakistan', 'Palestine', 'Philippines', 'Qatar', 'Saudi Arabia', 'Singapore',
           'South Korea', 'Sri Lanka', 'Syria', 'Tajikistan', 'Thailand', 'Timor-Leste', 'Turkmenistan', 'UAE',
...
def sort_countries_by_fifa_ranking(country_list):
    return sorted(country_list, key=lambda country: D.get(country, float('inf')))
...
def main12g():
    try:
        ...
        while not (Test):
            ...
            Test = (check(G1) and check(G2) and check(G3) and check(G4) and check(G4) and check(G5) and check(
                G6) and check(G7) and check(G8)) and check(G9) and check(G10) and check(G11) and check(G12)
...
def gotogroupsoreder():
    if match1entry.get() != "" and match2entry.get() != "" and match3entry.get() != "" and match4entry.get() != "" and match5entry.get() != "" and match6entry.get() != "" and match7entry.get() != "" and match8entry.get() != "" and match9entry.get() != "" and match10entry.get() != "" and match11entry.get() != "" and match12entry.get() != "" and match13entry.get() != "" and match14entry.get() != "" and match15entry.get() != "" and match16entry.get() != "" and match17entry.get() != "" and match18entry.get() != "" and match19entry.get() != "" and match20entry.get() != "" and match21entry.get() != "" and match22entry.get() != "" and match23entry.get() != "" and match24entry.get() != "":
        ...
        table1 = ttk.Treeview(g1tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table2 = ttk.Treeview(g2tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table3 = ttk.Treeview(g3tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table4 = ttk.Treeview(g4tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table5 = ttk.Treeview(g5tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table6 = ttk.Treeview(g6tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table7 = ttk.Treeview(g7tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table8 = ttk.Treeview(g8tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table9 = ttk.Treeview(g9tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                              show='headings')
        ...
        table10 = ttk.Treeview(g10tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                               show='headings')
        ...
        table11 = ttk.Treeview(g11tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                               show='headings')
        ...
        table12 = ttk.Treeview(g12tableframe, height=5, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                               show='headings')
        ...
        tablethird = ttk.Treeview(thirdtableframe, height=13, columns=('Rank', 'Country', 'Score', 'GS', 'GC', 'GT'),
                                  show='headings')
...
def showschedule12g():
    ...
    Score1, Score2, Score3, Score4, Score5, Score6, Score7, Score8, Score9, Score10, Score11, Score12 = [0, 0, 0, 0], [
        0, 0, 0, 0], [
