...
Euro = ["France","England","Germany","Italy","Netherlands","Switzerland","Denmark","Belgium","Croatia","Sweden","Spain","Portugal","Russia","Ukraine","Serbia","Wales","Scotland","Iceland"]

Afro = ["Algeria","Tunisia","Morocco","Egypt","Senegal","Nigeria","Cameroon","Ghana","Ivory Coast","South Africa"]

SA = ["Argentina","Brazil","Uruguay","Peru","Chile","Colombia","Ecuador","Paraguay"]

NA = ["USA","Mexico","Canada","Costa Rica","Panama","Jamaica","Hondoras","El Salvador"]

Asia = ["Australia","Japan","South Korea","North Korea","Palestine","KSA","UAE","Jordanie","Qatar","Iran"]
...
def main12g():
    try:
        ...
        P=[]
        P.append(Host)
        QCountries=sort_countries_by_fifa_ranking(QCountries)
        P+=QCountries
...
frame_of_46.grid(row=1,column=2,padx=5)
